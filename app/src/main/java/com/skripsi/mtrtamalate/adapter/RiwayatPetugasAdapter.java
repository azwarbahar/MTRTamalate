...
public class RiwayatPetugasAdapter extends RecyclerView.Adapter<RiwayatPetugasAdapter.MyHolderView> {

    private Context context;
    private ArrayList<Laporan> laporans;

    public RiwayatPetugasAdapter(Context context, ArrayList<Laporan> laporans) {
    ...
    @NonNull
    @Override
    public RiwayatPetugasAdapter.MyHolderView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view;
        view = LayoutInflater.from(context).inflate(R.layout.item_laporan, parent, false);
        RiwayatPetugasAdapter.MyHolderView myHolderView = new RiwayatPetugasAdapter.MyHolderView(view);
        return myHolderView;
    }

    @Override
    public void onBindViewHolder(@NonNull RiwayatPetugasAdapter.MyHolderView holder, int position) {
